...
public static class DatabaseMigrations
{
    public static async Task ApplyDatabaseMigrationsAsync(this WebApplication app)
    {
        ...
        try
        {
            ...
            Log.Debug("Database verification: {SymptomCount} symptoms found", symptomCount);
            ...
            {
                Log.Debug("Database is healthy with {SymptomCount} symptoms available", symptomCount);
            }
        }
        catch (Exception ex)
        {
