...
public class CancerConnectDbContext : DbContext
{
    ...
    private static void SeedData(ModelBuilder modelBuilder)
    {
        ...
        var symptoms = new[]
        {
            new Symptom { Id = 1, Name = "Anxiety", DisplayTitle = "Anxiety", Description = "Some common signs of anxiety include restlessness, irritability, sleep problems, difficulty controlling worry, concentration problems, and racing heartbeat.", Invalid = false },
            new Symptom { Id = 2, Name = "Appetite Loss", DisplayTitle = "Appetite Loss", Description = string.Empty, Invalid = false },
            new Symptom { Id = 3, Name = "Bleeding", DisplayTitle = "Bleeding", Description = string.Empty, Invalid = false },
            new Symptom { Id = 4, Name = "Impaired activity (ADLs)", DisplayTitle = "Impaired Activities", Description = string.Empty, Invalid = false },
            new Symptom { Id = 5, Name = "Constipation", DisplayTitle = "Constipation", Description = "Constipation is a condition characterized by infrequent bowel movements or difficulty passing stools, often resulting in discomfort.", Invalid = false },
            new Symptom { Id = 6, Name = "Cough", DisplayTitle = "Cough", Description = string.Empty, Invalid = false },
            new Symptom { Id = 7, Name = "Depression", DisplayTitle = "Depression", Description = "Depression can be marked by persistent feelings of sadness, hopelessness, and a lack of interest or pleasure in activities, often accompanied by changes in sleep, appetite, and energy levels.", Invalid = false },
            new Symptom { Id = 8, Name = "Diarrhea", DisplayTitle = "Diarrhea", Description = string.Empty, Invalid = false },
            new Symptom { Id = 9, Name = "Fatigue", DisplayTitle = "Fatigue", Description = string.Empty, Invalid = false },
            new Symptom { Id = 10, Name = "Fever", DisplayTitle = "Fever", Description = "You have a fever if your temperature exceeds 100.5°F (38.1°C).", Invalid = false },
            new Symptom { Id = 11, Name = "Nausea or Vomiting", DisplayTitle = "Nausea/Vomiting", Description = string.Empty, Invalid = false },
            new Symptom { Id = 12, Name = "Pain", DisplayTitle = "Pain", Description = string.Empty, Invalid = false },
            new Symptom { Id = 13, Name = "Tingling and Numbness in hands or feet", DisplayTitle = "Tingling/Numbness", Description = string.Empty, Invalid = false },
            new Symptom { Id = 14, Name = "Shortness of breath", DisplayTitle = "Shortness of Breath", Description = string.Empty, Invalid = false },
            new Symptom { Id = 15, Name = "Skin rash", DisplayTitle = "Skin Rash", Description = string.Empty, Invalid = false },
            new Symptom { Id = 16, Name = "Redness of skin", DisplayTitle = "Skin Redness", Description = string.Empty, Invalid = false },
            new Symptom { Id = 17, Name = "Edema/Swelling", DisplayTitle = "Swelling", Description = string.Empty, Invalid = false },
            new Symptom { Id = 18, Name = "Mouth Sores", DisplayTitle = "Mouth Sores", Description = string.Empty, Invalid = false },
            new Symptom { Id = 19, Name = "Level of Emotional Distress", DisplayTitle = "Emotional Distress", Description = string.Empty, Invalid = false },
        };
